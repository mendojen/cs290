...
app.get('/recentgames', function(req, res, next){
  var context = {};
  request('https://na.api.pvp.net/api/lol/' + req.query.game_region + '/v1.3/game/by-summoner/'+req.query.summonerid+'/recent?api_key='+credentials.riotKey, function(err, response, body){
