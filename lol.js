...
app.get('/recentgames', function(req, res, next){
  var context = {};
  request('https://na.api.pvp.net/api/lol/' + req.query.region + '/v1.3/game/by-summoner/'+req.query.userid+'/recent?api_key='+credentials.riotKey+'?format=json-pretty', function(err, response, body){
